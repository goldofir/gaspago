...
import {
  ...
  Network, TrendingUp, ShoppingBag, ChevronRight, Menu, X, Truck, CreditCard, LogOut, Store, Package, Users, Receipt, MessageCircle, GitBranch,
} from 'lucide-react'
...
const nav = [
  ...
  { href: '/admin/network',       label: 'Rede',          Icon: GitBranch },
